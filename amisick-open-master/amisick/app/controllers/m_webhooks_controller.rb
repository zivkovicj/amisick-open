class MWebhooksController < ApplicationController
  ...
  def kpi_opened(webhook) {
    gmail_opened_ip_1: (( webhook.ip_1.opened.gmail.size.to_f / webhook.ip_1.sent.gmail.size) * 100 ),
    hotmail_opened_ip_1: (( webhook.ip_1.opened.hotmail.size.to_f / webhook.ip_1.sent.hotmail.size) * 100 ),
    yahoo_opened_ip_1: (( webhook.ip_1.opened.yahoo.size.to_f / webhook.ip_1.sent.yahoo.size) * 100 ),
    other_opened_ip_1: (( webhook.ip_1.opened.other.size.to_f / webhook.ip_1.sent.other.size) * 100 ),
  }
  end
