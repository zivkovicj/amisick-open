class Sender < ApplicationRecord
  ...
  has_many :m_webhooks, through: :domain_infos
  has_many :t_webhooks, through: :domain_infos

  accepts_nested_attributes_for :domain_infos, allow_destroy: true
  ...
  scope :sent, lambda { where("m_webhooks.event LIKE ?", "delivered") }
  # Limiting
